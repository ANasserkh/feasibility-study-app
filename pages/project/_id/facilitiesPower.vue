<template>
  <div>
    <div class="mb-10">
      <h4 class="headline">Facilities & Power</h4>
      <p
        class="caption"
      >means collectively the Site Acquisition Costs, the Construction Costs, and Facility Equipment Costs incurred with respect to a Facility.</p>
    </div>
