<template>
	<div>
		<div class="mb-10">
			<h4 class="headline">Administrative Costs</h4>
			<p
				class="caption"
			>Administrative expenses are the expenses an organization incurs not directly tied to a specific function such as manufacturing, production, or sales.</p>
		</div>
